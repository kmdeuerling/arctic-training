...
author: 
    - "Kelly Deuerling, kmdeuerling@gmail.com"
    - "Second Author, isgreat@place.here"
date: "`r Sys.Date()`"
...
ggplot(diamonds, aes(x = carat, y = price, color = clarity))+
  theme_bw()+
  geom_point()+
  labs(x = "Carats", y = "Price (USD)")
```

And we can create a table as well if we want to show a model output.
